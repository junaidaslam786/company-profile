    ...
    <nav className="fixed bg-white border-b w-screen border-gray-200 z-50">
      <div className="relative flex items-center w-full h-24 justify-between px-4 md:justify-around">
        ...
        >
          <div className="flex flex-col items-start px-4">
            <Link href="/about-us" passHref>
              <span
                className="text-gray-600 hover:text-sky-500 py-2 cursor-pointer"
                style={{ fontSize: "1vw" }}
              >
                About Us
              </span>
            ...
            <Link href="/contact" passHref>
              <span
                className="inline-flex items-center p-2 border border-transparent font-medium rounded-md text-white bg-orange-500 hover:bg-orange-600 mt-2 cursor-pointer"
                style={{ fontSize: "1vw" }}
              >
                <FontAwesomeIcon
                  icon={faComments}
        ...
        >
          <Link href="/about-us" passHref>
            <span
              className="text-gray-600 hover:text-sky-500 px-3 py-2 rounded-md font-medium uppercase cursor-pointer"
              style={{ fontSize: "1vw" }}
            >
              About Us
            </span>
          ...
          >
            <button
              className="text-gray-600 hover:text-sky-500 px-3 py-2 rounded-md font-medium uppercase flex items-center"
              style={{ fontSize: "1vw" }}
            >
              What We Do{" "}
              <FontAwesomeIcon
          ...
          <Link href="/contact" passHref>
            <span
              className="inline-flex items-center p-2 border border-transparent font-medium rounded-md text-white bg-orange-500 hover:bg-orange-600 cursor-pointer"
              style={{ fontSize: "1vw" }}
            >
              <FontAwesomeIcon
                icon={faComments}
