  ...
  return (
    <Link href={"/events"} className="w-full h-full flex flex-col items-start">
      ...
      <div className="w-full flex flex-row items-center justify-between mt-[3vh]">
        <button className="uppercase text-blue-950 text-[1.3vw] md:text-[0.7vw] bg-blue-100 py-[0.7vw] px-[1.5vw] rounded-full">
          Webinar
        </button>
        <p className="uppercase text-blue-950 text-[1.5vw] md:-[0.8vw]">{dateTime}</p>
      </div>
      <p className="text-[3vw] md:text-[2vw] mt-[3vh] leading-tight text-blue-950 font-bold">
        {title}
      </p>
