    ...
    >
      ...
      <div className="h-2/3 w-full flex flex-col justify-between">
        <div className="w-full flex flex-row items-center justify-between mt-[3vh] md:mt-0 lg:mt-[3vh]">
          <p className="uppercase text-blue-950 text-[1.5vw] lg:text-[0.8vw]">{time}</p>
          <p className="uppercase text-blue-950 text-[1.5vw] lg:text-[0.8vw]">{dateTime}</p>
        </div>
        <p className="text-[3vw] lg:text-[1.5vw] mt-[3vh] md:mt-0 lg:mt-[3vh] leading-tight text-blue-950 font-bold">
          {title}
        </p>
      </div>
    </Link>
