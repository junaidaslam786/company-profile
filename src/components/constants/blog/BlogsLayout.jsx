...
const BlogsLayout = ({ title, id, button, children }) => {
  return (
    <div className="flex flex-col py-[5vw] w-full">
      <div className="flex flex-row w-full items-baseline justify-between py-[0.3vw] border-b border-blue-950">
        <p className="text-[3.5vw] text-blue-950 font-sans font-extrabold uppercase">
          {title}
        </p>
        <p className="text-[1vw] font-semibold text-blue-950">[{id}]</p>
      </div>
      <div className="mt-[3vw]">{children}</div>
      <div className="w-full flex flex-col items-center mt-[8vw]">
        <button className="p-[1vw] text-white bg-sky-500 group hover:bg-blue-950 uppercase flex flex-row items-center">
