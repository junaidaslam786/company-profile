...
const ScrollCard = ({ title, content, bottoms }) => {
  return (
    <Link
      href="/"
      className={`flex flex-row group justify-center items-center ${bottoms} border-l py-[5vw] md:py-0 md:h-[25vw] w-full`}
    >
      <div className="p-[1vw] w-full flex flex-col items-center relative z-10">
        ...
        <div className="w-5/6">
          ...
          <p className="mt-[1vh] text-gray-500 text-[2.5vw] md:text-[1vw]">{content}</p>
        </div>
      </div>
    </Link>
  );
