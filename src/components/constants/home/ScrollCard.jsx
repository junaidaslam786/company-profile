    ...
    >
      <div className="p-[1vw] w-full flex flex-col items-center relative z-10">
        <div className="absolute right-[8vw] md:right-[2vw] -mt-[2.4vh] group-hover:opacity-100 transition-opacity">
          <FaArrowRight className="text-[2.5vw] md:text-[1.5vw] transition-transform transform -rotate-45 text-gray-600 group-hover:rotate-0 group-hover:text-orange-500" />
        </div>
        <div className="w-5/6">
          <h3 className="group-hover:text-orange-500 font-semibold text-[4vw] md:text-[2vw] text-blue-950">
            {title}
          </h3>
