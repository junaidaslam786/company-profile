    ...
    <div className="w-full h-[50vh] group cursor-pointer border-b md:border-none flex flex-col items-center">
      <div className="w-5/6 h-full flex flex-col md:flex-row md:justify-between items-center">
        <div className="w-full md:w-2/3 h-[30vw] md:h-full flex flex-col md:border-b py-[2vw] items-start justify-between">
          <button className="text-blue-950 bg-sky-200 text-[2vw] md:text-[0.9vw] font-medium px-[2vw] py-[1.5vw] md:px-[1.5vw] md:py-[1vw] rounded-full">
            COST ESTIMATION
          </button>
          <p className="text-[3.5vw] md:text-[2vw] text-blue-950 font-semibold md:font-medium tracking-tight">
            {main}
          </p>
          ...
          <div className="w-full flex flex-row justify-between">
            <p className="text-[1.5vw] md:text-[0.9vw] uppercase text-blue-950">{date}</p>
            <p className="text-[1.5vw] md:text-[0.9vw] uppercase text-blue-950">{time}</p>
          </div>
        </div>
