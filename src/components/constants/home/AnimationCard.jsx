...
const AnimationCard = ({ id, title, content, hoveredColor }) => {
  return (
    <div className={`border group border-gray-600 w-4/6 bg-blueColor-0 flex flex-col justify-start items-start p-[15vmin] ${hoveredColor} hover:-translate-y-16 duration-500`}>
